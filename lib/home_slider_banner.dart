...
import 'banner_category_model.dart';
...
class _ImageSlideShowCustomState extends State<ImageSlideShowCustom> {
  ...
  Widget build(BuildContext context) {
    return bannerCategory==null?Shimmer(
        ...
        child: Container(color: Colors.grey.shade300,)): CarouselSlider.builder(
        ...
        itemBuilder:
          ...
          return Container(
            ...
            Image.network('https://bppshops.com/${bannerCategory![itemIndex].bennarImg}',fit: BoxFit.fill,)
  ...
  Future<void>getData() async{
    var url = Uri.parse(
        'https://bppshops.com/api/bannerCategory/view');
    http.Response response=await http.get(url);
    // print(response.body);
    List<dynamic>body=jsonDecode(response.body);
    bannerCategory=body.map((dynamic item) =>BannerCategory.fromJson(item)).toList();
    setState(() {
